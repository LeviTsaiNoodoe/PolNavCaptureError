...
//目前街道速限
@property (copy, nonatomic) CommonValueUnit *currentStreetLimitSpeed;
//目前速度
...
//是否有定位
@property (nonatomic) BOOL isLocationFixed;
//是否進入DR Mode
@property (nonatomic) BOOL isDRMode;
//是否在高速公路
@property (nonatomic) BOOL isOnHighway;
//是否在圓環內
@property (nonatomic) BOOL isOnRoundabout;
//是否在摩托車不可走的路上
@property (nonatomic) BOOL isOnMotorClosedStreet;
//Noodoe傳進來的車速
@property (assign, nonatomic) NSInteger noodoeSpeed;
/*
 ...
 * @param isLocationFixed 是否有定位
 * @param isOnHighway 是否在高速公路
 * @param isOnRoundabout 是否在圓環內
 * @param isOnMotorClosedStreet 是否在摩托車不可走的路上
 * @param noodoeSpeed Noodoe傳進來的車速
...
- (instancetype)initWithCurrentStreetName:(NSString *)streetName
                  ...
                  currentStreetLimitSpeed:(CommonValueUnit *)limitSpeed
                         currentRealSpeed:(NSInteger)realSpeed
                       currentFormatSpeed:(CommonValueUnit *)formatSpeed
                    ...
                    nextTurnCrossInfoData:(NextTurnCrossInfoData *)nextTurnCrossInfoData
                          isLocationFixed:(BOOL)isLocationFixed
                              isOnHighway:(BOOL)isOnHighway
                           isOnRoundabout:(BOOL)isOnRoundabout
                    isOnMotorClosedStreet:(BOOL)isOnMotorClosedStreet
                              noodoeSpeed:(NSInteger)noodoeSpeed;
